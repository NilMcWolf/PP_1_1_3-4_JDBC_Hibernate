...
public class UserDaoHibernateImpl extends Util implements UserDao {
    ...
    /**Необходимо отлавливать ошибки в рантайме в случае, если при выполнение транзакций вылетят ошибки, чтобы откатить
     *  изменения и прологировать из-за чего это произошло
     * todo: Логирование вижу, а откат изменений где? Посмотри что метод .rollback() у класса Transaction делает
     */
